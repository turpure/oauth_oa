...
//=========================================================================
    ...
    'weight1' => 150,//重量分界线（g）149
    'bwBasic' => 6,//超重基准值（￥）
    'swBasic' => 10.5,//未超重基准值（￥）
    'bwPrice' => 0.078,//超重单价（￥/g）
    'swPrice' => 0.046,//未超重单价（￥/g）

    //欧速通-英伦速邮追踪物流费参数
    'transport2' => '欧速通-英伦速邮追踪',//物流名称
    'weight2' => 540,//重量分界线（g）
    'weight3' => 2000,//重量分界线2（g）
    'weight4' => 20000,//重量分界线2（g）
    'wBasic' => 20,//大于等于540g基准值（￥）
    'price2' => 0.046,//540g-2000g单价（￥/g）
    'price3' => 0.05,//2000g-20000g单价（￥/g）
//====================================================================
