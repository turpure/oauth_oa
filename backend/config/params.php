...
//====================================================================
    ...
    //超大尺寸附加费
    'len_uk_tran_extra' => 120,//长度限制（cm）,超过120cm（不包括120），加收超大尺寸附加费
    'w_uk_tran_extra' => 15000,//重量限制（KG），超过15KG（不包括15），加收超大尺寸附加费
    'circum_uk_tran_extra' => 225,//综合限制（cm）,L+2*（W+H），超过225cm（不包括225），加收超大尺寸附加费
    'extra_fee' => 6, // 超大尺寸附加费, 单位：英镑
