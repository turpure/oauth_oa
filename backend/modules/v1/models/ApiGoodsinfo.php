        ...
        try {
            ...
            foreach ($wishSku as $sku) {
                ...
                // 人民币账号
                    ...
                    $var['localized_price'] = ceil((string)$sku['price'] * self::UsdExchange);
                }
                $variation[] = $var;
            }
            ...
            if ($isVar === '是') {
                ...
                //人民币账号
                    ...
                    $ret['local_price'] = ceil($ret['price'] * self::UsdExchange);
                    $ret['local_shippingfee'] = ceil($shipping * self::UsdExchange);
