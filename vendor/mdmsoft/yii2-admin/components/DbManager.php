...
class DbManager extends \yii\rbac\DbManager
{
    ...
    /**
     * @var string the name of the table storing department. Defaults to "auth_department".
     */

    public static $user = 'user';
    public static $departmentTable = 'auth_department';
    /**
     * @var string the name of the table storing department. Defaults to "auth_department_child".
     */
    public static $departmentChildTable = 'auth_department_child';
    /**
     * @var Connection|array|string the DB connection object or the application component ID of the DB connection.
     * After the DbManager object is created, if you want to change this property, you should only assign it
     * with a DB connection object.
...
//    public $db = 'db';
     ...
     * @return array
     */
    public function getDepartmentChild($user_id)
    {
        $query = (new Query)
            ->select(['department_id'])
            ->from([self::$departmentChildTable])
     ...
     * @return bool
     */
    public function assignDepartment($department_id, $user_id)
    {
        $this->db->createCommand()
            ->insert(self::$departmentChildTable, [
     ...
     * @return bool
     */
    public function revokeDepartment($department_id, $user_id)
    {
        $this->db->createCommand()
            ->delete(self::$departmentChildTable, [
                'department_id' => $department_id,
                'user_id' => $user_id
            ])->execute();
